  ...
  try {
    ...
    sendMail({
        ...
        body: `Hello ${req.body.fullname},<br/>
          Welcome to Tasky App. Please <a href="${config.get("URL")}/api/user/verify/email/${emailToken}">Click here</a> to verify your email.<br/><br/>
          Thank you,<br/>
          <b>Tasky App</b>`,
      });
...
sendSMS({
        ...
        body: `Hello ${req.body.fullname}
          Welcome to Tasky App. Please Click here to verify your mobile number:  ${config.get("URL")}/api/user/verify/sms/${smsToken}.`
